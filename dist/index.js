...
exports["default"] = async (octokit, owner, repo, newBranchName, sha) => {
...
const createBranch_1 = __importDefault(__nccwpck_require__(298));
exports.createBranch = createBranch_1.default;
const getAssisstantId_1 = __importDefault(__nccwpck_require__(251));
exports.getAssisstantId = getAssisstantId_1.default;
const getBranchName_1 = __importDefault(__nccwpck_require__(893));
...
const getGithubToken_1 = __importDefault(__nccwpck_require__(70));
...
const getProgramFolderBasePath_1 = __importDefault(__nccwpck_require__(873));
exports.getProgramFolderBasePath = getProgramFolderBasePath_1.default;
const getTestFolderBasePath_1 = __importDefault(__nccwpck_require__(997));
...
const verifyBranchExistence_1 = __importDefault(__nccwpck_require__(205));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports["default"] = async (octokit, owner, repo, newBranchName) => {
    try {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(186));
const runners_1 = __nccwpck_require__(670);
...
const run = async () => {
    try {
        ...
        const openaiKey = (0, runners_1.getOpenAIKey)();
        const assistantId = (0, runners_1.getAssisstantId)();
        const testFolderPath = (0, runners_1.getTestFolderBasePath)();
        const programFolderPath = (0, runners_1.getProgramFolderBasePath)();
        console.log(`Branch name: ${branchName}`);
